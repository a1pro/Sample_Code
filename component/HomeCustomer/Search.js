...
import {
  ...
  const Search =(props)=>{
      ...
      >
        ...
        <TouchableOpacity
        onPress={()=>props.functionOpenPage('SimpleSearch')}
          style={{
            width: "60%",
            height: "100%",
            justifyContent: "center",
        ...
        >
             ...
             <Text
               ...
               style={{color:Theme.PLACE_HOLDER}}
             >
             Search Products.....
             </Text>
        ...
        <View style={{ width: "25%", height: "100%", flexDirection: "row" }}>
          <TouchableOpacity 
           onPress={()=>props.functionOpenPage('VoiceSearch')}
          ...
          <TouchableOpacity
         onPress={()=>props.functionOpenPage('Scanner')}
              style={LocalStyle.MicContainer}
            >
              <Image
                style={{
