...
import ThemeListCmp from './ThemeListCmp';
import { connect } from 'react-redux';
import { GetThemeLists, GetShortTopMovers, AddTopMoveritemtoList } from '../../action';

class SeeThemeListContainer extends Component {
  ...
  constructor(props) {
    ...
    this.props.navigation.addListener(
      'willFocus',
      payload => {
        var mThemeType = this.props.navigation.getParam('PRODUCTTHEME');
        this.props.GetThemeLists(mThemeType);
...
export default connect(mapToStateProps, { GetThemeLists, GetShortTopMovers, AddTopMoveritemtoList})(SeeThemeListContainer);