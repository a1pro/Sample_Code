  ...
  return (
    <SafeAreaView forceInset={{ bottom: 'never' }} style={Styless.MainContainer}>
      ...
      >
        ...
        <View
          style={{ width: '100%', height: Platform.OS == 'ios'? '95%' :'89%', marginTop: 5  }}
        >
          <FlatList
            data={props.List}
            renderItem={({ item }) =>
              <View>
                ...
                <TouchableOpacity
                  ...
                  style={{ width: '100%', height: props.UserRole != 'Customer' ? 150 : 130 , flexDirection: 'row' }}>
                  ...
                  <View
                    ...
                    >
                     ...
                     {item.Quantity == 0 && 
                      <TouchableOpacity style={{ position: 'absolute', right: 2, flexDirection: 'row', marginTop: 5, }}>
