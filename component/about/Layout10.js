...
const Layout10 = (props) => {
  return (
        ...
        <ScrollView style={{width: '90%', height: '100%', marginLeft: '5%', marginRight: '5%', marginTop: 20}}>
          <Text allowFontScaling={false} style={{fontWeight: 'bold', marginTop: 20, fontSize: 20 }}>
