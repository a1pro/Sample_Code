...
import { View, StyleSheet, ImageBackground, Image, ScrollView, Text, TouchableOpacity, Keyboard} from 'react-native'
...
const Layout10 = props => {
  ...
  return (
    <ScrollView scrollEnabled={false} style={Styless.ScrollContainer}>
      <Image style={{ width: 180, height: 70, marginTop: 5, resizeMode: 'contain', alignSelf: 'center' }} source={LogoIcon} />
      <View style={{ width: '90%', marginBottom: 0, height: undefined, marginRight: '5%', marginLeft: '5%', marginTop: 0, backgroundColor: 'white', borderRadius: 5, paddingLeft: 10, paddingRight: 10 }}>
        <View style={{ flexDirection: 'row', width: '100%' }}>
          <View style={{ width: '48%', height: 40, borderBottomColor: '#757575', borderBottomWidth: 0.5, justifyContent: 'center', alignItems: 'flex-start', marginTop: 10, marginRight: 2 }}>
            <TextInput
          ...
          <View style={{ width: '48%', height: 40, borderBottomColor: '#757575', borderBottomWidth: 0.5, justifyContent: 'center', alignItems: 'flex-start', marginTop: 10, marginLeft: 2 }}>
            <TextInput
              style={{width:'100%', height:'100%'}}
              autoCorrect={false}
              multiline={false}
        ...
        style={{ width: '100%', height: 40, justifyContent: 'center', alignItems: 'center', backgroundColor: '#F79942', marginTop: 20, borderRadius: 10 }}>
          <Text allowFontScaling={false} style={{ color: 'black', fontWeight: 'bold' }}>
            SUBMIT
          </Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => props.functionOpenPage('Condition')} style={{ width: '100%', height: 40, justifyContent: 'center', alignItems: 'center' }}>
          <Text allowFontScaling={false} style={{ color: 'black', fontWeight: 'bold', textDecorationLine: 'underline', color: '#F79942'}}>
            Terms & Conditions
          </Text>
        </TouchableOpacity>
      </View>
