...
import { View, Text, FlatList,  TouchableOpacity, ActivityIndicator,StyleSheet, Picker, Dimensions, Platform } from 'react-native'
    ...
    <SafeAreaView forceInset={{ bottom: 'never' }}
      ...
      >
       <Header {...props} />
        ...
        <View
          style={{ width: '100%', height: Platform.OS == 'ios'? '85%' :'80%' }}
        >
...
const LocalStyle = StyleSheet.create({
  ...
  Image_Container: {
    width: '30%', height: '100%', justifyContent: 'center', alignItems: 'center', marginTop: -10
  },
