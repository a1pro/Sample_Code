  ...
  return (
    <SafeAreaView
      ...
      <View
        ...
        /> : <View />}
        <View
          style={{ position: 'absolute', bottom: 0, width: '100%', height: 120, backgroundColor: 'white' }}
        >

          <Text
            allowFontScaling={false}
            style={{ textAlign: 'center', fontSize: 17, marginLeft: 15, marginRight: 15, fontWeight: 'bold', color: 'black', marginTop: 7 }}>
            Enable Auto Add to List to immediately add scanned items to your shopping List.</Text>
          <View
            style={{ flexDirection: 'row', width: '100%', height: undefined, marginTop: 0,justifyContent:'center', alignItems:'center' }}
          >
            
            <Text
              style={{ textAlign: 'center', marginTop: 0, fontSize: 17, fontWeight: 'bold', color: 'black' }}
              allowFontScaling={false}
            >
              Auto Add to Default List 
               </Text>
            <TouchableWithoutFeedback
              onPress={() => props.functionAddToList('')}
            >
              <Image
                style={{ width: 70, height: 70, resizeMode: 'contain', marginLeft: 10 }}
                source={props.AddList == true ? ToggleON : ToggleOff}
              />
